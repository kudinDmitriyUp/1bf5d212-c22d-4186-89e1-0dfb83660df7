...
export const metadata: Metadata = {
  title: "Ukraine Situation - Information and Support Resources",
  description: "Factual, verified information about the Ukraine crisis, humanitarian impact, and ways to support affected communities.",
  keywords: "Ukraine, humanitarian crisis, aid organizations, refugee support, verified information, conflict documentation",
  metadataBase: new URL("https://ukraine-awareness.org"),
  alternates: {
    canonical: "https://ukraine-awareness.org"
  },
  openGraph: {
    title: "Ukraine Situation - Stay Informed",
    description: "Understanding the humanitarian emergency and international response",
    siteName: "Ukraine Awareness Platform",
    type: "website"
  },
  twitter: {
